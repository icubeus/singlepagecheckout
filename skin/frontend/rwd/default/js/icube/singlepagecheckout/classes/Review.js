...
Review.prototype = {
    ...
    initialize: function (id, getStepUpdateUrl, submitOrderUrl, successUrl) {
        ...
        this.getStepUpdateUrl = getStepUpdateUrl || baseUrl + 'checkout/singlepage/updateOrderReview';
        this.submitOrderUrl   = submitOrderUrl  || baseUrl + 'checkout/singlepage/submitOrder';
        this.successUrl       = successUrl || baseUrl + 'checkout/singlepage/success';
