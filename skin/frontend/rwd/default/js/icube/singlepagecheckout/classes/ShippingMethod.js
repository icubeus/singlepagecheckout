...
ShippingMethod.prototype = {
    ...
    initialize: function (id, getStepUpdateUrl, saveStepData) {
        ...
        this.getStepUpdateUrl      = getStepUpdateUrl || baseUrl + 'checkout/singlepage/updateShippingMethods';
        this.saveShippingMethodUrl = saveStepData || baseUrl + 'checkout/singlepage/saveShippingMethod';
