...
Payment.prototype = {
    ...
    initialize: function (id, getPaymentMethodsUrl, savePaymentMethodUrl) {
        ...
        this.getPaymentMethodsUrl = getPaymentMethodsUrl || baseUrl + 'checkout/singlepage/updatePaymentMethods';
        this.savePaymentMethodUrl = savePaymentMethodUrl || baseUrl + 'checkout/singlepage/savePaymentMethod';
